 ...
 */
router.post('/sales/:versionId', upload.single('file'), async (req: Request, res: Response) => {
 ...
 */
router.post('/construction/:versionId', upload.single('file'), async (req: Request, res: Response) => {
  const db: Pool = req.app.get('db');
  const { versionId } = req.params;
 ...
 */
router.post('/units/:versionId', upload.single('file'), async (req: Request, res: Response) => {
  const db: Pool = req.app.get('db');
  const { versionId } = req.params;
  ...
  try {
    ...
    console.error('Error importing units data:', error);
    res.status(500).json({
 ...
 */
router.post('/tenants/:versionId', upload.single('file'), async (req: Request, res: Response) => {
  const db: Pool = req.app.get('db');
  const { versionId } = req.params;
  ...
  try {
    ...
    console.error('Error importing tenants data:', error);
    res.status(500).json({
 ...
 */
router.post('/plan/:versionId', upload.single('file'), async (req: Request, res: Response) => {
  const db: Pool = req.app.get('db');
  const { versionId } = req.params;
 ...
 */
router.get('/status/:versionId', async (req: Request, res: Response) => {
  const db: Pool = req.app.get('db');
  const { versionId } = req.params;
